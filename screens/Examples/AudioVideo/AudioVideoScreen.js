...
const ICON_PLAY_BUTTON = new Icon(require('../../../assets/images/audio-video/play_button.png'), 34, 51);
const ICON_PAUSE_BUTTON = new Icon(require('../../../assets/images/audio-video/pause_button.png'), 34, 51);
const ICON_STOP_BUTTON = new Icon(require('../../../assets/images/audio-video/stop_button.png'), 22, 22);
const ICON_FORWARD_BUTTON = new Icon(require('../../../assets/images/audio-video/forward_button.png'), 33, 25);
const ICON_BACK_BUTTON = new Icon(require('../../../assets/images/audio-video/back_button.png'), 33, 25);

const ICON_LOOP_ALL_BUTTON = new Icon(require('../../../assets/images/audio-video/loop_all_button.png'), 77, 35);
const ICON_LOOP_ONE_BUTTON = new Icon(require('../../../assets/images/audio-video/loop_one_button.png'), 77, 35);

const ICON_MUTED_BUTTON = new Icon(require('../../../assets/images/audio-video/muted_button.png'), 67, 58);
const ICON_UNMUTED_BUTTON = new Icon(require('../../../assets/images/audio-video/unmuted_button.png'), 67, 58);

const ICON_TRACK_1 = new Icon(require('../../../assets/images/audio-video/track_1.png'), 166, 5);
const ICON_THUMB_1 = new Icon(require('../../../assets/images/audio-video/thumb_1.png'), 18, 19);
const ICON_THUMB_2 = new Icon(require('../../../assets/images/audio-video/thumb_2.png'), 15, 19);
...
export default class AudioVideoScreen extends Component {
    constructor(props) {
        super(props);
        this.index = 0;
